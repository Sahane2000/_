...
$sql = "SELECT distinct(region),total_water FROM nashik";  
...
<html>  
 ...
 <body>  
 <h2 align="center"><a href="nashikmap.php">View Region Wise Data Through Map</a><h2>
 <h2 align="center"><a href="nashiktaluka1.php">View Taluka Wise(Total Water Required)</a><h2>
  <div class="container">  
   <br />  
   <br />  
   <br />  
   <div class="table-responsive">  
    ...
    <br />
    <form method="post" action="nashik_region.php">
